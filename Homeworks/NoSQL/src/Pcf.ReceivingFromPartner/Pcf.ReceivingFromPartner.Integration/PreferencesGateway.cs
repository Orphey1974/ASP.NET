...
namespace Pcf.ReceivingFromPartner.Integration
{
    ...
    public class PreferencesGateway : IPreferencesGateway
    {
        ...
        {
            var preferencesApiUrl = _configuration["IntegrationSettings:PreferencesApiUrl"];
            var response = await _httpClient.GetAsync($"{preferencesApiUrl}/api/v1/preferences");
        ...
        {
            var preferencesApiUrl = _configuration["IntegrationSettings:PreferencesApiUrl"];
            var response = await _httpClient.GetAsync($"{preferencesApiUrl}/api/v1/preferences/{id}");
